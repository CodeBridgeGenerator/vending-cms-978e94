...
const HCMasterFormCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit H C Master Form" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="hCMasterForm-edit-dialog-component">
