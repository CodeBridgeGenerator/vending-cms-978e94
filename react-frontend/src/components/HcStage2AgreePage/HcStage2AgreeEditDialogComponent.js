...
const HcStage2AgreeCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        await client.service("hcStage2Agree").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info hcStage2Agree updated successfully" });
    ...
    return (
        <Dialog header="Edit ~cb-service-displayName~" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            style={{ maxWidth: "55vw" }} role="hcStage2Agree-edit-dialog-component">
                <div>
