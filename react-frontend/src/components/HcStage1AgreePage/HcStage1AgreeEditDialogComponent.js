...
const HcStage1AgreeCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit ~cb-service-displayName~" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            style={{ maxWidth: "55vw" }} role="hcStage1Agree-edit-dialog-component">
                <div>
            ...
            <span className="align-items-center">
                ...
                <InputText id="ManagerProceed" type="text" value={_entity?.ManagerProceed} onChange={(e) => setValByKey("ManagerProceed", e.target.value)}  />
            </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
