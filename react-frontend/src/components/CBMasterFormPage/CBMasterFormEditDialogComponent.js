...
const CBMasterFormCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit C B Master Form" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
